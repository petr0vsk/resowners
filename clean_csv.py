...
df = pd.read_excel('/home/petr0vsk/owners_2.xlsx', sheet_name = 0, header = 2, skiprows = [0],  index_col = None, names = ['server', 'disk', 'path', 'owner', 'second_owner', 'memo'], usecols=[0,1,2,3,4,5])
...
df.to_csv('/home/petr0vsk/owners_2.csv', sep = ',', index=False)
